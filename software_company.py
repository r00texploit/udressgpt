...
def generate_repo(
    ...
    if not recover_path:
        ...
        if implement or code_review:
            if is_flutter:
                company.hire([FlutterDeveloper(use_code_review=code_review)])
            else:
                company.hire([Engineer2(n_borg=5, use_code_review=code_review)])
...
def startup(
    ...
    is_flutter: bool = typer.Option(default=False, help="Whether the project is a Flutter project."),
):
