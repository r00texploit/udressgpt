...
# @register_provider([LLMType.OPENAI, LLMType.FIREWORKS, LLMType.OPEN_LLM, LLMType.MOONSHOT, LLMType.MISTRAL, LLMType.YI, LLMType.DEEPSEEK])
...
#             "timeout": self.get_timeout(self.config.timeout),
#             "max_retries": 3,
#         }
...
#     @retry(
#         wait=wait_random_exponential(min=1, max=30),  # Reduced max wait time to 30 seconds
#         stop=stop_after_attempt(5),  # Reduced max attempts to 5
...
#             openai.APIError,
#             openai.InternalServerError  # Changed from ServiceUnavailableError to InternalServerError
#         )),
